...
for i= 1:150
    ...
    [DispB,QB,BetaB] = PoliNavigationSolver(0,PP_use,6);
...
%%
%save('ResultNavigation2.mat',"Array_BetaB","Array_Disp","Array_QB"); 
Array_BetaB(:,1)=Orbit(:,1);
Array_QB(:,1)=Orbit(:,1);
Array_Disp(:,1)=Orbit(:,1);
...
hold on
scatter3(quater0(:,2),quater0(:,3),quater0(:,4),3,'k','filled');
hold off
...
figure(2)
scatter3(PPmR_rotB(:,1),PPmR_rotB(:,2),PPmR_rotB(:,3),1,PPmR_rotB(:,3),'filled');
hold on
